...
@section('title', 'Edit experience - ' . $profile->name)

@section('page-title', 'Edit experience - ' . $profile->name)
...
<form action="{{ route('experiences.update', $experience) }}"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
            <label class="block font-medium mb-1">Company <span class="text-red-500">*</span></label>
            <input type="text"
                    name="company"
        ...
        <div>
            <label class="block font-medium mb-1">Role <span class="text-red-500">*</span></label>
            <input type="text"
                    name="role"
        ...
        <!-- Dates -->
        <div>
            <label class="block font-medium mb-1">Start date <span class="text-red-500">*</span></label>
            <input type="date"
                    name="start_date"
