...
@section('title', 'Add project - ' . $profile->name)

@section('page-title', 'Add project - ' . $profile->name)
...
<form action="{{ route('profiles.projects.store', $profile) }}"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
            <label class="font-medium">Project name <span class="text-red-500">*</span></label>
            <input type="text" name="name"
                    class="w-full border rounded-lg px-3 py-2"
                    required>
        </div>
        <div>
            <label class="font-medium">Project link <span class="text-red-500">*</span></label>
